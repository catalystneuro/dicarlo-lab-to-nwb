...
folder_path = Path("/media/heberto/One Touch/DiCarlo-CN-data-share/StimulusSets/SFM_foveal_videos_2/meta")
train_test_split_data_file_path = folder_path / "SFM.foveal.videos_2_stratified.csv"
